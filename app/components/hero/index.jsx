...
const Hero = ({ handlerFormOpen }) => {
  ...
  return (
    <div className={styles.hero} ref={heroRef}>
      ...
      >
        <motion.span initial={{opacity: 0, y: 60}} animate={{opacity: 1, y: 0, transition: { duration: 0.5, delay: 0 } }} className="sm:inline-flex ">proiect</motion.span>
        <motion.span initial={{opacity: 0, y: 60}} animate={{opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.2 } }} className="inline-flex ml-[90rem] tracking-tighter">
          imobiliar
        </motion.span>
        <motion.span initial={{opacity: 0, y: 60}} animate={{opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.3 } }} className="inline-flex sm:ml-[-150rem]">exclusivist</motion.span>
      </motion.h1>
      <motion.p initial={{opacity: 0 }} animate={{opacity: 1, transition: { duration: 0.2, delay: 0.4 } }} className={styles.hero__text_decor}>
        Lansare {""}
        <br className="inline-block sm:hidden" />
        ENSŌ LIVING
      </motion.p>
      <motion.p initial={{opacity: 0 }} animate={{opacity: 1, transition: { duration: 0.4 } }} className={styles.text__building_high}>
        un penthouse{""}
        <br />
        high-end
      </motion.p>
      <motion.p initial={{opacity: 0 }} animate={{opacity: 1, transition: { duration: 0.4 } }} className={styles.text__building_low}>
        showroom {""}
        <br />
        comercial {""}
        <br className="inline-block sm:hidden" />
      ...
      <motion.p initial={{opacity: 0 }} animate={{opacity: 1, transition: { duration: 0.4 } }} className={styles.text__building_middle}>
        duplexuri{""}
        <br />
        de lux  
      </motion.p>
