      ...
      <div className={styles.premium__inner}>
        <div className={styles.premium__header_inner}>
          ...
          <div className={styles.premium__title_content}>
            ...
            >
              The most exclusive penthouse in Brasov, {""}
              <br />arranged across 3 levels — an architectural {""}
              <br />masterpiece offering serenity at altitude
            </motion.p>
          </div>
        </div>
          ...
          <div className={styles.inner__list}>
            ...
            >
              ...
              <p className={styles.item__text}>
                <span>Private indoor garden </span> a green sanctuary where {""}
                <br />
                all 4 seasons come to life
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <p className={styles.item__text}>
                <span>Jacuzzi area: </span>moments of relaxation at height, {""}
                <br />with unobstructed view
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <p className={styles.item__text}>
                <span>Customisable design:</span> an individually conceived  {""}
                <br />
                interior reflecting your authentic personal style
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <p className={styles.item__text}>
                <span>Breathtaking views: </span>a 360° panoramic {""}
                <br />
                perspective over the city and the mountains
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <p className={styles.item__text}>
                <span>Total area of 532.62 sqm </span> distributed {""}
                <br />
                across 3 levels and designed for  {""}
                <br />
                impeccable functionality and  {""}
                <br />
                comfort
              </p>
            </motion.div>
