      ...
      <div className={styles.premium__inner} ref={ref}>
        <div className={styles.premium__header_inner}>
          <div className={styles.premium__title_image}>
            <Building />
            <motion.div
              className="w-[42rem] h-[19rem] absolute top-[13rem] left-[22rem] translate-0 z-2"
              initial={{ opacity: 0 }}
          ...
          <div className={styles.premium__title_content}>
            ...
            >
              Generous two-level residences filled with natural 
              <br />light through panoramic glazing, offering the feel 
              <br />of an urban townhouse — balancing openness, 
              <br />privacy, and striking views.
            </motion.p>
          </div>
        </div>
