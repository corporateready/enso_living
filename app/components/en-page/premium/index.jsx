        ...
        <div className={styles.premium__header_inner}>
          <div className={styles.premium__title_image}>
            ...
            <motion.div
              ...
              className="w-[76rem] h-[30rem] absolute bottom-[10rem] left-[2rem] translate-0 z-3"
            >
              <Image
                src="/building-1.webp"
                alt="building part"
        ...
        <div className={styles.premium__content}>
          ...
          <div className={styles.inner__list}>
            ...
            >
              ...
              <span className={styles.item__text}>
                Reception & access control – modern security {""}
                <br />
            ...
            >
              ...
              <span className={styles.item__text}>
                Direct access to the lobby and restaurant
              </span>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <span className={styles.item__text}>Smart climate control systems</span>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <span className={styles.item__text}>
                Private balconies on every level – ideal
                <br />
                for relaxation and efficient networking
              </span>
            </motion.div>
          </div>
          <button
