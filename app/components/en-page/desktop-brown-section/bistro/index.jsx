        ...
        <div className={styles.inner}>
          <div className={styles.inner__header}>
            <div className={styles.head__content}>
              ...
              >
                Fine dining arranged over 2 levels 
                <br />ground floor and mezzanine, direct 
                <br />access for residents and the office area
          ...
          >
            <span className={styles.span__text}>
              Request an offer for Bistro / Restaurant
            </span>
