      ...
      <div className={styles.container}>
        <div className={styles.terms__content}>
          ...
          <p className={styles.description}>
            ...
            use of "NOTORIUM" S.R.L.'s Website, located at ensoliving.ro.
          </p>
          <p className={styles.description}>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use ENSO LIVING if you do not agree
          ...
          <p className={styles.description}>
            We employ the use of cookies. By accessing ENSO LIVING, you agreed
            to use cookies in agreement with the "NOTORIUM" S.R.L. Privacy
            Policy.
          </p>{" "}
          <p className={styles.description}>
          ...
          <p className={styles.description}>
            Unless otherwise stated, "NOTORIUM" S.R.L. and/or its licensors own
            the intellectual property rights for all material on ENSO LIVING.
            All intellectual property rights are reserved. You may access this
            from ENSO LIVING for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>
          <p className={styles.description}>You must not:</p>
          <p className={styles.description}>
            "NOTORIUM" S.R.L. reserves the right to monitor all Comments and to
          ...
          <p className={styles.description}>
            ...
            grant "NOTORIUM" S.R.L. a non-exclusive license to use, reproduce,
          ...
          <p className={styles.description}>
            ...
            absence of "NOTORIUM" S.R.L. and (d) the link is in the context of
          ...
          <p className={styles.description}>
            ...
            sending an e-mail to "NOTORIUM" S.R.L. Please include your name,
          ...
          <p className={styles.description}>
            ...
            format of content on the linking party’s site. No use of "NOTORIUM "
            S.R.L.'s logo or other artwork will be allowed for linking absent a
