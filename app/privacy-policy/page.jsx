      ...
      <div className={styles.container}>
        <div className={styles.terms__content}>
          <p className={styles.headLine__title}>
            Privacy Policy for "NOTORIUM" S.R.L.
          </p>
          <p className={styles.description}>
            At ENSO LIVING, accessible from avenew.md, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by ENSO LIVING and how we use it. If you have additional
            ...
            regards to the information that they shared and/or collect in ENSO
            LIVING. This policy is not applicable to any information collected
            offline or via channels other than this website.
          </p>
          <p className={styles.title}>Consent</p>
          <p className={styles.description}>
            By using our website, you hereby consent to our Privacy Policy and
            agree to its terms.
          </p>{" "}
          <p className={styles.title}>Information we collect</p>
          <p className={styles.description}>
          ...
          <p className={styles.title}>How we use your information</p>
          <p className={styles.description}>
            ...
            fraud By contacting the official representatives of ENSO LIVING
          ...
          <p className={styles.description}>
            ENSO LIVING follows a standard procedure of using log files. These
          ...
          <p className={styles.description}>
            Like any other website, ENSO LIVING uses 'cookies'. These cookies
          ...
          <p className={styles.description}>
            ...
            advertising partners of ENSO LIVING. Third-party ad servers or ad
            ...
            appear on ENSO LIVING, which are sent directly to users' browsers.
            ...
            that you see on websites that you visit. Note that ENSO LIVING has
            no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <p className={styles.title}>Third Party Privacy Policies</p>
          <p className={styles.description}>
            ENSO LIVING Privacy Policy does not apply to other advertisers or
          ...
          <p className={styles.title}>GDPR Data Protection Rights</p>
          <p className={styles.description}>
          ...
          <p className={styles.title}>Children's Information</p>
          <p className={styles.description}>
            Another part of our priority is adding protection for children while
            using the internet. We encourage parents and guardians to observe,
            participate in, and/or monitor and guide their online activity. ENSO
            LIVING does not knowingly collect any Personal Identifiable
